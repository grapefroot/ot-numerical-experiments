...
def full_repair(data_first, data_second, y_first, y_second, coupling, weights=[0.5, 0.5]):
...
def partial_repair(interpolation_weight, data_first, data_second, y_first, y_second, coupling, weights=[0.5, 0.5]):
    mapped_class_0, mapped_class_1 = construct_map(weights, data_first, data_second, coupling)
...
def random_repair(interpolation_weight, theta, data_first, data_second, y_first, y_second, coupling, weights=[0.5, 0.5]):
    mapped_class_0, mapped_class_1 = construct_map(weights, data_first, data_second, coupling)
